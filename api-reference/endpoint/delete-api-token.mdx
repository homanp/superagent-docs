...
api: "DELETE https://superagent-qqrg5.ondigitalocean.app/api/v1/api-tokens/{tokenId}"
...
curl --location --request DELETE 'https://superagent-qqrg5.ondigitalocean.app/api/v1/api-tokens' \
