---
title: "/documents"
api: "POST https://superagent-qqrg5.ondigitalocean.app/api/v1/documents"
...
curl --location --request POST 'https://superagent-qqrg5.ondigitalocean.app/api/v1/documents' \
