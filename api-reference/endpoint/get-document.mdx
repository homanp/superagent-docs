...
api: "GET https://superagent-qqrg5.ondigitalocean.app/api/v1/documents/{documentId}"
...
curl --location --request GET 'https://superagent-qqrg5.ondigitalocean.app/api/v1/documents/{documentId}' \
