---
title: "/agents"
api: "POST https://superagent-qqrg5.ondigitalocean.app/api/v1/agents"
...
curl --location --request POST 'https://superagent-qqrg5.ondigitalocean.app/api/v1/api-tokens' \
